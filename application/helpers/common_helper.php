        ...
        foreach ($acquired_grade as $grade) {
          if ($acquired_number >= $grade['mark_from'] && $acquired_number <= $grade['mark_upto']) {
            ...
            if (!empty($type)) {
              ...
              return $grade['name'].'<br>'.$grade['name_fr'];
            }
          }
        }
        if(!$founder){
...
{
  function get_grades($acquired_number = "", $type = "") {
    $CI =&  get_instance();
    $CI->load->database();
    if (empty($acquired_number)) {
      return "N/A";
...
// GET discipline DECISIONs
if ( ! function_exists('get_discipline_decision'))
{
  function get_discipline_decision($acquired_number = "", $option = "",  $school = "",  $session = "") {
    $CI =&  get_instance();
    $CI->load->database();
    if (empty($acquired_number)) {
      return "-";
      ...
      $acquired_grade = $CI->db->get_where('decisions', array('type' =>'discipline',$option = "", 'school_id'=>$school,'session' => $session));
      if ($acquired_grade->num_rows() > 0) {
        $acquired_grade = $acquired_grade->result_array();
        $founder = false;
        foreach ($acquired_grade as $grade) {
          if ($acquired_number >= $grade['from'] && $acquired_number <= $grade['to']) {
            $founder = true;
            if (!empty($type)) {
              return $grade[$type];
            }else{
              return $grade['name'].' / '.$grade['name_fr'];
            }
          }
        }
        if(!$founder){
...
// GET CLASS COUNCIL DECISION
if ( ! function_exists('get_class_council'))
{
  function get_class_council($acquired_number = "", $school = "",  $session = "") {
    $CI =&  get_instance();
    $CI->load->database();
    if (empty($acquired_number)) {
      return "-";
      ...
      $acquired_grade = $CI->db->get_where('decisions', array('type' =>'class_council', 'school_id'=>$school,'session' => $session));
      if ($acquired_grade->num_rows() > 0) {
        $acquired_grade = $acquired_grade->result_array();
        $founder = false;
        foreach ($acquired_grade as $grade) {
...
if ( ! function_exists('get_class_councilf'))
{
  function get_class_councilf($acquired_number = "",  $school = "",  $session = "") {
    $CI =&  get_instance();
    $CI->load->database();
    if (empty($acquired_number)) {
      return "-";
...
//// GET CLASS COUNCIL DECISION
//if ( ! function_exists('get_class_promo'))
//{
//  function get_class_promo($acquired_number = "", $school = "",  $session = "") {
//    $CI =&  get_instance();
//    $CI->load->database();
//    if (empty($acquired_number)) {
//      return "-";
//    }else{
//        
//      $acquired_grade = $CI->db->get_where('decisions', array('type' =>'promotion', 'school_id'=>$school,'session' => $session));
//      if ($acquired_grade->num_rows() > 0) {
//        $acquired_grade = $acquired_grade->result_array();
//        $founder = false;
//        foreach ($acquired_grade as $grade) {
...
//}
//
//if ( ! function_exists('get_class_promof'))
//{
//  function get_class_promof($acquired_number = "",  $school = "",  $session = "") {
//    $CI =&  get_instance();
//    $CI->load->database();
//    if (empty($acquired_number)) {
//      return "-";
...
//if ( ! function_exists('get_class_promoex'))
//{
//  function get_class_promoex($acquired_number = "", $school = "",  $session = "") {
//    $CI =&  get_instance();
//    $CI->load->database();
//    if (empty($acquired_number)) {
//      return "-";
...
//if ( ! function_exists('get_class_promofex'))
//{
//  function get_class_promofex($acquired_number = "",  $school = "",  $session = "") {
//    $CI =&  get_instance();
//    $CI->load->database();
//    if (empty($acquired_number)) {
//      return "-";
