...
/*
*  @author   : everblue solutions
*  School Management System With Addons
*
*/
...
class Superadmin extends CI_Controller {
  ...
  //START CLASS secion 
  public function manage_school($param1 = '', $param2 = '', $param3 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->school_create();
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->school_delete($param2);
      echo $response;
    }
      
    if($param1 == 'delete_option'){
      $response = $this->crud_model->school_option_delete($param2);
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->school_update($param2);
      echo $response;
    }
      
    if ($param1 == 'update_current') {
      $response = $this->settings_model->update_current_school_settings();
      echo $response;
    }

    if($param1 == 'division'){
      $response = $this->crud_model->division_update($param2);
      echo $response;
    }
      
    if($param1 == 'option'){
      $response = $this->crud_model->option_update($param2);
      echo $response;
    }
    ...
    if(empty($param1)){
      ...
      $page_data['page_title'] = 'manage_schools';
      $this->load->view('backend/index', $page_data);
    }
  }
  ...
  //START fees secion 
  public function fees($param1 = '', $param2 = '', $param3 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->fees_create();
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->fees_delete($param2);
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->fees_update($param2);
      echo $response;
    }

    // show data from database
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/fees/list');
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'fees';
      $page_data['page_title'] = 'manage_schools_fees';
      $this->load->view('backend/index', $page_data);
    }
  }
  ...
  public function manage_class($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'delete_option'){
      $response = $this->crud_model->class_option_delete($param2);
      echo $response;
    }
  ...
  //START MARKS SETTINGS SECTION
  public function mark_settings($param1 = '', $param2 = '', $param3 = ''){

    if($param1 == 'create'){ 
      $response = $this->crud_model->behavior_create();
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->behavior_delete($param2);
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->behavior_update($param2);
      echo $response;
    }

    if($param1 == 'section'){
      $response = $this->crud_model->section_b_update($param2);
      echo $response;
    }

    // show data from database
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/mark_settings/list');
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'mark_settings';
      $page_data['page_title'] = 'mark_behaviors';
      $this->load->view('backend/index', $page_data);
    }
  }
  //END CLASS section
//	DIVISION STARTED
 public function division($action = "", $id = "") {

  // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
  if ($action == 'list') {
    $page_data['class_id'] = $id;
    $this->load->view('backend/superadmin/division/list', $page_data);
  }
}
//	OPTION STARTED
 public function option($action = "", $id = "", $sub = "") {

  // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
  if ($action == 'list') {
    $page_data['class_id'] = $id;
    $this->load->view('backend/superadmin/option/list', $page_data);
  }
  if ($action == 'lists') {
    $page_data['class_id'] = $id;
    $this->load->view('backend/superadmin/option/lists', $page_data);
  }
  // showing the list of expense
  if ($action == 'lists_edit') {
      $page_data['class_id'] = $id;
      $page_data['subject'] = $sub;
      $this->load->view('backend/superadmin/option/lists_edit', $page_data);
    }
  ...
  public function section($action = "", $id = "") {
    ...
    if ($action == 'lists') {
      $page_data['class_id'] = $id;
      $this->load->view('backend/superadmin/section/lists', $page_data);
    }
    
      // PROVIDE A LIST OF DEPARTMENT ACCORDING TO CLASS ID
    if ($action == 'dep_list') {
      $page_data['dep_id'] = $id;
      $this->load->view('backend/superadmin/section/dep_list', $page_data);
    }
  }
  //	DEPARTMENT STARTED
  public function region_department($action = "", $id = "") {
  ...
  public function subject_settings($param1 = '', $param2 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->subjects_create();
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->subjects_update($param2);
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->subjects_delete($param2);
      echo $response;
    }

    if($param1 == 'list'){
      $page_data['class_id'] = $param2;
      $this->load->view('backend/superadmin/subject_settings/list', $page_data);
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'subject_settings';
      $page_data['page_title'] = 'subject_settings';
      $this->load->view('backend/index', $page_data);
    }
  }

  public function discipline_settings($param1 = '', $param2 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->discipline_create();
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->discipline_update($param2);
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->discipline_delete($param2);
      echo $response;
    }

    if($param1 == 'list'){
      $page_data['class_id'] = $param2;
      $this->load->view('backend/superadmin/discipline_settings/list', $page_data);
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'discipline_settings';
      $page_data['page_title'] = 'discipline_settings';
      $this->load->view('backend/index', $page_data);
    } 
  }
    
  public function decision_settings($param1 = '', $param2 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->decision_create();
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->decision_update($param2);
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->decision_delete($param2);
      echo $response;
    }

    if($param1 == 'list'){
      $page_data['class_id'] = $param2;
      $this->load->view('backend/superadmin/decision_settings/list', $page_data);
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'decision_settings';
      $page_data['page_title'] = 'school_decisions';
      $this->load->view('backend/index', $page_data);
    }
  }

  public function class_wise_subject($class_id, $section_id, $exam_id) {

    // PROVIDE A LIST OF SUBJECT ACCORDING TO CLASS ID
    $page_data['class_id'] = $class_id;
    $page_data['section_id'] = $section_id;
    $page_data['doing'] = $exam_id;
    $this->load->view('backend/superadmin/subject/dropdown', $page_data);
  }
    
  public function class_wise_subjects($class_id,$section_id, $exam_id) {

    // PROVIDE A LIST OF SUBJECT ACCORDING TO CLASS ID
    $page_data['class_id'] = $class_id;
    $page_data['section_id'] = $section_id;
    $page_data['doing'] = $exam_id;
    $this->load->view('backend/superadmin/subject/dropdowns', $page_data);
  }
  //END SUBJECT section


  //START DOCUMENTS HEADERS section
  public function document_headers($param1 = '', $param2 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->header_create();
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->header_update($param2);
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->header_delete($param2);
      echo $response;
    }

    // Get the data from database
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/document_headers/list');
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'document_headers';
      $page_data['page_title'] = 'document_headers';
      $this->load->view('backend/index', $page_data);
    }
  }
  //END HEADERS section
  ...
  //START USERS PERMISSION section
  public function users_permission($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'modify_permission'){
      ...
      $page_data['section_id'] = htmlspecialchars($this->input->post('section_id'));
      $this->user_model->teacher_permission();
      $this->load->view('backend/superadmin/users_permission/list', $page_data);
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'users_permission';
      $page_data['page_title'] = 'users_permissions';
      $this->load->view('backend/index', $page_data);
    }
  }
  //END TEACHER PERMISSION section
  ...
  public function exam($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'section'){
      $response = $this->crud_model->section_e_update($param2);
      echo $response;
    }

    // show data from database
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/exam_settings/list');
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'exam_settings';
      $page_data['page_title'] = 'exam_settings';
      $this->load->view('backend/index', $page_data);
    }
  }
  //END EXAM section
  ...
  public function mark($param1 = '', $param2 = ''){
    ...
    if($param1 == 'inserts'){
      $this->crud_model->inserts(); 
    }
      
    if($param1 == 'mark_update_all'){
      $this->crud_model->mark_update_all();
    }
    ...
    //START MARKSHEET section
  public function marksheet($param1 = '', $param2 = ''){
    ...
    if($param1 == 'list'){
      ...
      $page_data['subject_id'] = htmlspecialchars($this->input->post('subject'));
      $page_data['exam_id'] = htmlspecialchars($this->input->post('exam'));
      //$this->crud_model->marksheet_insert($page_data['class_id'], $page_data['section_id'], $page_data['subject_id'], $page_data['exam_id']);
      $this->load->view('backend/superadmin/marksheet/list', $page_data);
    }
    ...
    if(empty($param1)){
      $page_data['folder_name'] = 'marksheet';
      $page_data['page_title'] = 'marksheet';
      $this->load->view('backend/index', $page_data);
    }
  }   
    
    //START MARKSHEET section
  public function report_card($param1 = '', $param2 = ''){

    if($param1 == 'list'){
      $page_data['class_id'] = htmlspecialchars($this->input->post('class_id'));
      $page_data['section_id'] = htmlspecialchars($this->input->post('section_id'));
      $page_data['exam_id'] = htmlspecialchars($this->input->post('exam_id'));
      $page_data['exam'] = htmlspecialchars($this->input->post('exam'));
      $page_data['display'] = htmlspecialchars($this->input->post('display'));
      $this->load->view('backend/superadmin/report_card/list', $page_data);
    }

    if($param1 == 'average_update'){
      $this->crud_model->average_update();
    }
      
//    if($param1 == 'average_updateg'){
//      $this->crud_model->average_updateg();
//    }
    ...
    if(empty($param1)){
      $page_data['folder_name'] = 'report_card';
      $page_data['page_title'] = 'report_card';
      $this->load->view('backend/index', $page_data);
    }
  } 
    
  public function discipline($param1 = '', $param2 = ''){

    if($param1 == 'list'){
      $page_data['class_id'] = htmlspecialchars($this->input->post('class_id'));
      $page_data['section_id'] = htmlspecialchars($this->input->post('section_id'));
      $page_data['exam_id'] = htmlspecialchars($this->input->post('exam'));
      $this->crud_model->discipline_insert($page_data['class_id'], $page_data['section_id'], $page_data['exam_id']);
      $this->load->view('backend/superadmin/discipline/list', $page_data);
    }

    if($param1 == 'disciplines_update'){
      $this->crud_model->disciplines_update();
    }
      
    if($param1 == 'discipline_update_all'){
      $this->crud_model->discipline_update_all();
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'discipline';
      $page_data['page_title'] = 'discipline';
      $this->load->view('backend/index', $page_data);
    }
  }
  ...
  public function get_grades($acquired_mark) {
    echo get_grades($acquired_mark);
  }  
public function get_mark($class, $section, $sub, $exam, $stud) {
    echo $this->crud_model->get_mark($class, $section, $sub, $exam, $stud);
  }  
    
public function get_t_coef($class_id, $section_id, $exam_id, $student_id) {
    echo $this->crud_model->get_subdiv_average($class_id, $section_id, $exam_id, $student_id)->row()->total_coef;
}  
public function get_t_mark($class_id, $section_id, $exam_id, $student_id) {
...
public function get_marks($class, $section, $sub, $exam, $behavior) {
    echo $this->crud_model->get_markm($class, $section, $sub, $exam, $behavior);
  }  
    
public function get_class_council($acquired_mark) {
    echo get_class_council($acquired_mark);
  }
  //END MARKS sesction
  ...
  function promotion($param1 = "", $promotion_data = "") {
    ...
    if ($param1 == 'promotered') {
      $response = $this->crud_model->redouble_student($promotion_data);
      echo $response;
    }
    if ($param1 == 'promoteprom') {
      $response = $this->crud_model->promote_students($promotion_data);
      echo $response;
    }
    ...
    if ($param1 == 'list') {
      ...
      $page_data['section_from'] = htmlspecialchars($this->input->post('section_from'));
      $page_data['section_to'] = htmlspecialchars($this->input->post('section_to'));
      ...
      //$page_data['section_to_details'] = $this->crud_model->get_section($this->input->post('section_to'))->row_array();
      ...
      $page_data['winners'] = $this->crud_model->get_global_winners($page_data['class_id_from'], $page_data['section_from'])->result_array();
      $page_data['losers'] = $this->crud_model->get_global_losers($page_data['class_id_from'], $page_data['section_from'])->result_array();
  ...
  public function export_student($param1 = "", $class_id = "", $section_id = "") {
    //RETURN EXPORT URL
    if ($param1 == 'url') {
      $type = htmlspecialchars($this->input->post('type'));
      $class_id = htmlspecialchars($this->input->post('class_id'));
      $section_id = htmlspecialchars($this->input->post('section_id'));
      echo route('export_student/'.$type.'/'.$class_id.'/'.$section_id);
    }
    // EXPORT AS PDF
    if($param1 == 'pdf' || $param1 == 'print') {
      $page_data['action']   = $param1;
      $page_data['class_id'] = $class_id;
      $page_data['section_id'] = $section_id;
      $html = $this->load->view('backend/superadmin/student/export',$page_data, true);
      ...
      // FILE DOWNLOADING CODES
      $class_details = $this->crud_model->get_classes($class_id)->row_array();
      $classNameForTitle = $class_details['name'];

      $fileName = 'Student_list-'.$classNameForTitle.'.pdf';
    ...
    if($param1 == 'printm') {
      ...
      $page_data['class_id'] = $class_id;
      $page_data['section_id'] = $section_id;
      $html = $this->load->view('backend/superadmin/student/exportm',$page_data, true);
  ...
  public function export_report_card($param1 = "", $class_id = "", $section_id = "", $display = "", $exam_id = "", $exam = "") {
    //RETURN EXPORT URL
    if ($param1 == 'url') {
      $type = htmlspecialchars($this->input->post('type'));
      $display = htmlspecialchars($this->input->post('display'));
      $class_id = htmlspecialchars($this->input->post('class_id'));
      $section_id = htmlspecialchars($this->input->post('section_id'));
      $exam = htmlspecialchars($this->input->post('exam'));
      $exam_id = htmlspecialchars($this->input->post('exam_id'));
      echo route('export_report_card/'.$type.'/'.$class_id.'/'.$section_id.'/'.$display.'/'.$exam_id.'/'.$exam);
    }
    // EXPORT AS PDF
    if($param1 == 'pdf' || $param1 == 'print') {
      $page_data['action']   = $param1;
      $page_data['class_id'] = $class_id;
      $page_data['section_id'] = $section_id;
      $page_data['display'] = $display;
      $page_data['exam_id'] = $exam_id;
      $page_data['exam'] = $exam;
      $html = $this->load->view('backend/superadmin/report_card/export',$page_data, true);
      ...
      $fileName = 'Student_marksheets-'.$classNameForTitle.'.pdf';
  ...
  public function export_marksheet($param1 = "", $class_id = "", $section_id = "", $subject_id = "", $exam_id = "") {
    //RETURN EXPORT URL
    if ($param1 == 'url') {
      $type = htmlspecialchars($this->input->post('type'));
      $class_id = htmlspecialchars($this->input->post('class_id'));
      ...
      $exam_id = htmlspecialchars($this->input->post('exam'));
      echo route('export_marksheet/'.$type.'/'.$class_id.'/'.$section_id.'/'.$subject_id.'/'.$exam_id);
    }
    // EXPORT AS PDF
    if($param1 == 'pdf' || $param1 == 'print') {
      $page_data['action']   = $param1;
      ...
      $page_data['exam_id'] = $exam_id;
      $html = $this->load->view('backend/superadmin/marksheet/export',$page_data, true);
  ...
  // SETTINGS MANAGER
  public function thesystems_settings($param1 = "", $param2 = "") {
    if ($param1 == 'update') {
      $response = $this->settings_model->update_system_settings();
      echo $response;
    }
    ...
    if(empty($param1)){
      $page_data['folder_name'] = 'settings';
      $page_data['page_title']  = 'system_settings';
      $page_data['settings_type'] = 'thesystems_settings';
      $this->load->view('backend/index', $page_data);
    }
  }
