...
class Settings_model extends CI_Model {
  ...
  public function update_system_settings() {
    ...
    $data['multiple_school'] = htmlspecialchars($this->input->post('ms'));
    ...
    $data['allow_catch_up'] = htmlspecialchars($this->input->post('ce'));
    $data['catch_up_decision'] = htmlspecialchars($this->input->post('ced'));
    $data['exam_to_catch'] = htmlspecialchars($this->input->post('etc'));
    $data['catchup_max'] = htmlspecialchars($this->input->post('cp'));
    $data['mark_to_catch'] = htmlspecialchars($this->input->post('am'));
    $data['average_promote'] = htmlspecialchars($this->input->post('saverage'));
    $data['max_mark'] = htmlspecialchars($this->input->post('maxmark'));
  ...
  public function update_current_school_settings() {
    ...
    $data['short_name'] = htmlspecialchars($this->input->post('school_sname'));
    $data['phone'] = htmlspecialchars($this->input->post('phone'));
    ...
    if ($_FILES['logo']['name'] != "") {
      move_uploaded_file($_FILES['logo']['tmp_name'], 'uploads/system/school/'.school_id().'.png');
    }
