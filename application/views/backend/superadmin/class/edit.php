    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            ...
            <select name="typec" id="typec" class="form-control select2" data-toggle = "select2">
                <option value="0"<?php if($class['type'] == 0){ echo 'selected'; } ?>><?php echo get_phrase('passing_class'); ?></option>
                <option value="1"<?php if($class['type'] == 1){ echo 'selected'; } ?>><?php echo get_phrase('exam_class'); ?></option>
            </select>
...
<script>
    ...
    $('#blank_section').hide();
    initSelect2(['#u', '#school','#typec', '#section_id','#previous', '#option_id']);
});
