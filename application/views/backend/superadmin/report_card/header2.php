			...
			<tr style=" 
               ...
               <?php if($department['type'] ==1){?>
                    <td><strong>
                        ...
                        <img style="margin-top: -5px; " width="70" height="70" src="<?php echo $this->crud_model->get_col1_image($department['id']); ?>"></strong>
                        <?php } ?>
                    </td>
               <?php } elseif($department['type'] ==2){?>
                    <td>
                        ...
                        <?php if (file_exists('uploads/column/col1/'.$department['id'].'.png')){?>
                        <img style="margin-top: -5px; " width="70" height="70" src="<?php echo $this->crud_model->get_col1_image($department['id']); ?>">
                        <?php } ?>
                    </td>
                    <td> 
                        ...
                        <img style="margin-top: -5px; " width="70" height="70" src="<?php echo $this->crud_model->get_col2_image($department['id']); ?>">
                        <?php } ?>
                    </td>
               <?php } elseif($department['type'] ==3){?>
                    ...
                    <td>
                        ...
                        <img style="margin-top: -5px; " width="70" height="70" src="<?php echo $this->crud_model->get_col3_image($department['id']); ?>">
                        <?php } ?>
                    </td>
               <?php } elseif($department['type'] ==4){?>
                    ...
                    <td>
                        ...
                        <img style="margin-top: -5px; "  width="70" height="70" src="<?php echo $this->crud_model->get_col4_image($department['id']); ?>">
                        <?php } ?>
                    </td>
               <?php } ?>
			</tr> 
