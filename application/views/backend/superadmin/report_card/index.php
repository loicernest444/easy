        ...
        <div class="card">
            <div class="row mt-3">
                <div class="col-md-2 mb-1">
                    <select name="exam_id" id="exam_id" class="form-control select2" data-toggle = "select2" required onchange="wiseExam(this.value)">
...
function filter_attendance(){
    ...
    if(class_id != "" && section_id != "" && exam_id != "" && exam != ""){
        //calculate();
        //calculateg();
        $.ajax({
            type: 'POST',
...
//        if(class_id != "" && section_id != "" && exam != ""){
            $.ajax({
                ...
                data : {class_id : class_id, section_id : section_id, exam : exam ,exam_id : exam_id,},
                success : function(response){
                    toastr.success('<?php echo get_phrase('class_averages_has_been_updated_successfully'); ?>');
                }
            });
//        }else{
