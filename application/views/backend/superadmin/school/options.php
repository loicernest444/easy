...
<form method="POST" class="d-block ajaxForm" action="<?php echo route('manage_school/option/'.$param1); ?>">
    <?php $count = 0; ?>
    <?php $sections = $this->db->get_where('division_option', array('division_id' => $param1))->result_array(); ?>
    <?php $n = $this->db->get_where('division_option', array('division_id' => $param1))->num_rows(); ?>
