    ...
    <?php foreach($sections as $section){
        ...
        <?php if($count > 1){ ?>
            <div class="form-row mr-2" id="sectionDatabase<?php echo $section['id']; ?>">
                ...
                <div class="form-group col-6">
                    <input type="text" class="form-control" id="division_name" name = "division_name[]" value="<?php echo $section['name_fr']; ?>" placeholder="<?php echo get_phrase('french_name'); ?>" required>
                </div>
                <div class="form-group col-5">
