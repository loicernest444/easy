                    ...
                    <form method="POST" class="col-12 schoolForm" action="<?php echo route('school_settings/update') ;?>" id = "schoolForm">
                        <div class="col-12">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-secondary col-xl-12 col-lg-12 col-md-12 col-sm-12" onclick="updateSchoolInfo()"><?php echo get_phrase('update_settings') ;?></button>
                            </div>
                        </div>
                    </form> 
