        ...
        <?php 
            ...
            <tr>
                    ...
                    <?php
                      foreach($exs as $bids){
                        ...
                        $id = $this->crud_model->get_idmarks_average($mark['class_id'], $mark['section_id'], $sub['id'], $bids['id'], $mark['student_id']);
                            if($co == 1){ ?>
                                <td <?php if($this->crud_model->get_stmarks_average($mark['class_id'], $mark['section_id'], $sub['id'], $bids['id'], $mark['student_id'])->row()->mark_obtained < 10) { ?> style="color:red;" <?php } ?>><?php echo $this->crud_model->get_stmarks_average($mark['class_id'], $mark['section_id'], $sub['id'], $bids['id'], $mark['student_id'])->row()->mark_obtained;?></td>
                            <?php }else{
                            foreach($cos as $coss){?>
                              <td><?php echo $this->crud_model->get_bmarks_average($coss['id'], $id);?></td>
                            <?php }   ?>
                              <td<?php if($this->crud_model->get_stmarks_average($mark['class_id'], $mark['section_id'], $sub['id'], $bids['id'], $mark['student_id'])->row()->mark_obtained < 10) { ?> style="color:red;" <?php } ?>><?php echo 
                    ...
                    foreach($exs as $bids){ ?>
                        ...
                        <td><?php echo $this->crud_model->get_subdiv_average($class_id, $section_id, $bids['id'], $mark['student_id'])->row()->total_coef;?></td>
    ...
    <table class="table table-bordered table-responsive-sm" width="100%"  style="overflow: auto; white-space: nowrap;">
        ...
        <?php 
            ...
            <tr>
                    ...
                    <?php
                      foreach($exs as $bids){
                        ...
                        $id = $this->crud_model->get_idmarks_average($mark['class_id'], $mark['section_id'], $subject_id, $bids['id'], $mark['student_id']);
                            ...
                            if($co == 1){ ?>
                                <td <?php if($this->crud_model->get_stmarks_average($mark['class_id'], $mark['section_id'], $subject_id, $bids['id'], $mark['student_id'])->row()->mark_obtained < 10) { ?> style="color:red;" <?php } ?>><?php echo $this->crud_model->get_stmarks_average($mark['class_id'], $mark['section_id'], $subject_id, $bids['id'], $mark['student_id'])->row()->mark_obtained;?></td>
                            <?php }else{
                            foreach($cos as $coss){?>
                              <td><?php echo $this->crud_model->get_bmarks_average($coss['id'], $id);?></td>
                            <?php }   ?>
                    ...
                    <td style="background-color: #ccc; text-align:center;"><?php echo $this->crud_model->get_subject_average($mark['class_id'], $mark['section_id'], $subject_id, $exam_id, $mark['student_id'])->row()->coef; ?></td>
                    <td  style="text-align:center; <?php if($this->crud_model->get_subject_average($mark['class_id'], $mark['section_id'], $subject_id, $exam_id, $mark['student_id'])->row()->mark_obtained < 10) { ?>; color:red; <?php } ?>"><?php echo $this->crud_model->get_subject_average($mark['class_id'], $mark['section_id'], $subject_id, $exam_id, $mark['student_id'])->row()->mark_obtained; ?></td>
