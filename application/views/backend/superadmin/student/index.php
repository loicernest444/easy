            ...
            <div class="card alert alert-info">
                <div class="card-body">
                    <h4 class="page-title">
                        ...
                        <a href="<?php echo route('student/create'); ?>" class="btn btn-outline-primary alignToTitle"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_new_student'); ?></a>
                    </h4>
                </div> <!-- end card body-->
            </div> <!-- end card -->
        </div><!-- end col-->
                ...
                <div class="card-body">
                 <div class="row justify-content-md-center" style="margin-bottom: 10px;">
                     <div class="col-md-3 mb-1">
                        <small id="" class="form-text text-muted"><?php echo get_phrase('Action'); ?></small>
                        <select name="act" id="act" class="form-control select2" data-toggle = "select2" required onchange="filter_student()">
                            <option value="1"><?php echo get_phrase('view'); ?></option>
                            <option value="2"><?php echo get_phrase('bulk_edit'); ?></option>
                        </select>
                    </div>
...
var showAllStudents = function() {
    ...
    if(class_id != "" && section_id!= ""){
        $.ajax({
            url: '<?php echo route('student/filter/') ?>'+class_id+'/'+section_id+'/'+action,
            success: function(response){
