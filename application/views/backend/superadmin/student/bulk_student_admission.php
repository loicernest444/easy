            ...
            <div class="col-xl-11 col-lg-11 col-md-12 col-sm-12 mb-3 mb-lg-0">
                <div class="row justify-content-md-center">
                    ...
                    <div class="form-group col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-1 mb-lg-0">
                        <label class="form-label" for="name"><?php echo get_phrase('birthday'); ?>(dd/mm/yy)</label>
                        <input type="text" class="form-control date" name = "birthday[]"   value="<?php echo date("d/m/Y"); ?>">
                    </div>
