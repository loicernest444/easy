<?php
  $school_id = school_id();
?>
<h4><?php echo get_phrase('student_list'); ?></h4>
...
<table width="100%" style="border-collapse: collapse;">
  <thead>
    <tr style="background-color: #313a46; text-align: center;">
      ...
      <th style="border : 1px solid black; color: #fff; "><?php echo get_phrase('origin'); ?></th>
      <th style="border : 1px solid black; color: #fff; "><?php echo get_phrase('contact'); ?></th>
    </tr>
  </thead>
  <tbody>
    <?php
