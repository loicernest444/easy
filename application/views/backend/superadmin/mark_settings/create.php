<form method="POST" class="d-block ajaxForm" action="<?php echo route('mark_settings/create'); ?>">
    <div class="form-row">
        <?php 
        ...
        <div class="form-group  col-md-12">
            ...
            <small id="name_help" class="form-text text-muted">% : <?php echo get_phrase('representation_in_total_mark'); ?></small>
        </div>
        
        <div class="form-group  col-md-12">
            <button class="btn btn-block btn-primary" type="submit"><?php echo get_phrase('create_mark_behavior'); ?></button>
        </div>
    </div>
</form>
