...
<div class="left-side-menu left-side-menu-detached content-main">
  ...
  <div class="leftbar-user">
      <form class="" action="<?php echo site_url($controller.'/search/result'); ?>" method="post">
        <input class="form-control" type="search" name="search" placeholder="<?php echo get_phrase('search_for_anything'); ?>">
      </form>
  </div>
