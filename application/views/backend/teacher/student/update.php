    ...
    <div class="col-md-12">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-4" <?php if($this->user_model->get_user_details($student['user_id'], 'birthtype') != 'on') echo 'style="display:none"'; ?> id="bd1">
                ...
                <input type="text" class="form-control date" id="birthdatepicker" data-toggle="date-picker" data-single-date-picker="true" name = "birthday"  value="<?php echo date('m/d/Y', $this->user_model->get_user_details($student['user_id'], 'birthday')); ?>">
            </div>
